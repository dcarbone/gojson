...
final class Transcoding
{
    ...
    public const ZERO_STRING  = '';
    public const ZERO_INTEGER = 0;
    public const ZERO_DOUBLE  = 0.0;
    public const ZERO_FLOAT   = self::ZERO_DOUBLE;
    public const ZERO_BOOLEAN = false;
